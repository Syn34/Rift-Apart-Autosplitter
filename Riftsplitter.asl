...
state("RiftApart")
{
	bool isPortalLoading: 0x0671E108, 0x5308;
	...
	int cutscene: 0x6A45048, 0x0, 0x208, 0x314; 
...
reset
{
	return timer.Run.CategoryName.Substring(0,4)!="100%" && old.cutscene != current.cutscene && current.cutscene == 1284869723;	
}
